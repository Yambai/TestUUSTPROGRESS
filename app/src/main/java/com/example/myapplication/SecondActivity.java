...
public class SecondActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if  (!isConnected()){
            Toast.makeText(SecondActivity.this, "Отсутствует интернет", Toast.LENGTH_SHORT).show();
        }
        ...
        login_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(username.getText().toString().equals("admin") && password.getText().toString().equals("admin")){
                    Toast.makeText(SecondActivity.this, "URA", Toast.LENGTH_SHORT).show();
                }else {
                    Toast.makeText(SecondActivity.this, "FUUUUU", Toast.LENGTH_SHORT).show();
